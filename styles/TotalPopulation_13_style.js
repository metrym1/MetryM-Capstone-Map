...
var style_TotalPopulation_13 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Mina Metry Caps Data Epi and Bios QG_Overall_Pop");
    var labelText = "";
    size = 0;
    ...
    var offsetY = 3;
    var placement = 'point';
    if (feature.get("Mina Metry Caps Data Epi and Bios QG_Overall_Pop") !== null) {
        labelText = String(feature.get("Mina Metry Caps Data Epi and Bios QG_Overall_Pop"));
    }
    if (value >= 53120.000000 && value <= 91638.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 91638.000000 && value <= 125603.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 125603.000000 && value <= 166924.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 166924.000000 && value <= 204829.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 204829.000000 && value <= 263039.000000) {
            style = [ new ol.style.Style({
