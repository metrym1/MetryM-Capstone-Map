...
var style_RaceOther_8 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Mina Metry Caps Data Epi and Bios QG_Race_Other");
    var labelText = "";
    size = 0;
    ...
    var offsetY = 3;
    var placement = 'point';
    if (feature.get("Mina Metry Caps Data Epi and Bios QG_Race_Other") !== null) {
        labelText = String(feature.get("Mina Metry Caps Data Epi and Bios QG_Race_Other"));
    }
