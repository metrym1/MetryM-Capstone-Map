...
var style_RaceWhite_10 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Mina Metry Caps Data Epi and Bios QG_Race_Asian");
    var labelText = "";
    size = 0;
    ...
    var offsetY = 3;
    var placement = 'point';
    if (feature.get("Mina Metry Caps Data Epi and Bios QG_Race_Asian") !== null) {
        labelText = String(feature.get("Mina Metry Caps Data Epi and Bios QG_Race_Asian"));
    }
    if (value >= 1.000000 && value <= 3.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 3.000000 && value <= 12.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 25.000000 && value <= 39.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 39.000000 && value <= 54.000000) {
            style = [ new ol.style.Style({
