...
var style_RaceBlack_11 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Mina Metry Caps Data Epi and Bios QG_Race_Black");
    var labelText = "";
    size = 0;
    ...
    var offsetY = 3;
    var placement = 'point';
    if (feature.get("Mina Metry Caps Data Epi and Bios QG_Race_Black") !== null) {
        labelText = String(feature.get("Mina Metry Caps Data Epi and Bios QG_Race_Black"));
    }
    if (value >= 1.000000 && value <= 12.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 12.000000 && value <= 25.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 25.000000 && value <= 40.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 40.000000 && value <= 69.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 69.000000 && value <= 88.000000) {
            style = [ new ol.style.Style({
