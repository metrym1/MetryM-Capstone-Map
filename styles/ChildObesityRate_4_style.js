...
var style_ChildObesityRate_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Mina Metry Caps Data Epi and Bios QG_Child_Obesity");
    var labelText = "";
    size = 0;
    ...
    var offsetY = 3;
    var placement = 'point';
    if (feature.get("Mina Metry Caps Data Epi and Bios QG_Child_Obesity") !== null) {
        labelText = String(feature.get("Mina Metry Caps Data Epi and Bios QG_Child_Obesity"));
    }
    if (value >= 5.000000 && value <= 7.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 11.000000 && value <= 18.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 18.000000 && value <= 22.000000) {
            style = [ new ol.style.Style({
