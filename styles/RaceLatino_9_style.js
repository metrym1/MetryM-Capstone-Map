...
var style_RaceLatino_9 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Mina Metry Caps Data Epi and Bios QG_Race_Latino");
    var labelText = "";
    size = 0;
    ...
    var offsetY = 3;
    var placement = 'point';
    if (feature.get("Mina Metry Caps Data Epi and Bios QG_Race_Latino") !== null) {
        labelText = String(feature.get("Mina Metry Caps Data Epi and Bios QG_Race_Latino"));
    }
    if (value >= 7.000000 && value <= 10.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 18.000000 && value <= 30.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 30.000000 && value <= 51.000000) {
            style = [ new ol.style.Style({
